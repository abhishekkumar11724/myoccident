...
const ArchiveCard = ({ title, des, link, listItem }: Props) => {
    return (
        <a href={link} target="_blank">
            <div className="w-full h-80 rounded-lg bg-[#BFBFBF] p-7 flex flex-col  gap-6 hover:-translate-y-2 transition-transform duration-300 group">
