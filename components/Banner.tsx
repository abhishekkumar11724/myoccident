...
const Banner = () => {
    return (
        <section
            id="home"
            className="max-w-contentContainer mx-auto py-10 mdl:py-24 flex flex-col gap-4 lgl:gap-8 mdl:px-10 px-4"
        >
            <motion.h3
            ...
            <motion.p
                ...
                className="text-base md:max-w-[650px] text-textDark front-medium"
            >
